...
function App() {
  ...
  return (
    <div className="bg-[#B49594] text-white min-h-screen overflow-x-hidden">
      {/* Header */}
      <header
      ...
      >
        <nav className="container mx-auto px-4 flex justify-between items-center">
          <h2 className="text-2xl font-extrabold tracking-tight bg-gradient-to-r from-pink-400 via-[#9A7E7D] to-red-400 bg-clip-text text-transparent bold">
            CS 
          </h2>
          ...
          <ul className="hidden md:flex space-x-8 items-center">
            {['Profile', 'Skills', 'Certifications', 'Education', 'Projects'].map((item) => (
              <li key={item}>
                ...
                >
                  {item}
                  <span className="absolute left-0 bottom-0 w-0 h-[2px] bg-gradient-to-r from-[#B49594] to-[#C9B1BD] transition-all duration-300 group-hover:w-full"></span>
                </a>
              </li>
            ))}
            <li>
      ...
      <footer className="relative bg-gradient-to-t from-gray-900 to-black text-center py-12 border-t border-gray-800 overflow-hidden">
        ...
        <div className="relative z-10 space-y-4">
          <p className="text-gray-400 font-extrabold">
            &copy; 2025 Chamathya Sepiyumi. All rights reserved.
          </p>
        </div>
      </footer>
