  ...
  const contactInfo = [
    {
      icon: Mail,
      label: 'Email',
      value: 'karandeni28dewage@gmail.com',
      href: 'karandeni28dewage@gmail.com',
      color: 'from-sky-400 to-cyan-400',
    },
    {
      icon: Phone,
      label: 'Phone',
      value: '+94 76 716 2677',
      href: 'tel:+94767162677',
  ...
  const socialLinks = [
    {
      icon: Github,
      label: 'GitHub',
      href: 'https://github.com/Du2002',
    },
    {
      icon: Linkedin,
      label: 'LinkedIn',
      href: 'http://linkedin.com/in/chamathya-sepiyumi-387047378',
    },
  ];
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(1200px 600px at 15% 20%, rgba(191, 124, 157, 1), transparent 60%), radial-gradient(900px 500px at 85% 80%, rgba(161, 109, 107, 1), transparent 60%)',
        }}
      />
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        >
          ...
          <div className="h-1 w-24 bg-gradient-to-r from-[#B49594] to-[#CE7571] mx-auto mt-4" />
          <p className="text-gray-400 mt-4 text-lg max-w-2xl mx-auto">
            Ready to connect? I'm excited to hear from you about your questions or 
            collaborative ideas!
          </p>
        </div>
          ...
          <div className="space-y-8">
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-3xl font-bold bg-gradient-to-r from-pink-400 bg-clip-text  ">
                  Let's Connect
                </h3>
              </div>
              <p className="text-gray-400 mb-8 text-lg leading-relaxed">
                I welcome the opportunity to discuss new projects, creative initiatives, 
                and potential collaborations. Please feel free to contact me with any 
                inquiries or to simply introduce yourself.
              </p>
                  ...
                  >
                    ...
                    <div className="relative flex-1">
                      ...
                      {item.href ? (
                        <a
                          href={item.href}
                          className="text-white font-medium hover:text-pink-400 transition-colors duration-300 text-base"
                        >
                          {item.value}
                        </a>
                      ) : (
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-pink-400 focus:border-transparent transition-all duration-300"
              ...
              <div>
                ...
                <textarea
                  ...
                  required
                  rows="6"
                  className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-pink-400 focus:border-transparent transition-all duration-300 resize-none"
      ...
      <style>{`
        ...
        .contact-info-card:hover {
          border-color:  rgba(199, 30, 24, 0.69);
          box-shadow: 0 10px 40px rgba(195, 27, 114, 0.66);
        }
        ...
        .contact-form-card:hover {
          box-shadow:
            ...
            0 12px 38px rgba(248, 56, 171, 0.4);
        ...
        .btn-submit {
          background: linear-gradient(#000, #000) padding-box,
                      linear-gradient(90deg,  #B49594, #C9B1BD) border-box;
        ...
        .btn-submit:hover:not(:disabled) {
          background: linear-gradient(90deg, #B49594, #C9B1BD);
          color: #000;
          box-shadow: 0 0 30px  #b495947c;
        }
        ...
        .social-link:hover {
          background: linear-gradient(135deg,  rgba(154, 126, 125, 1));
          border-color: rgba(248, 56, 171, 0.4);
        }
        ...
        input:focus, textarea:focus {
          box-shadow: 0 0 0 3px rgba(248, 56, 171, 0.4));
        }
      `}</style>
    </section>
  );
