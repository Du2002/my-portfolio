...
import rbvlogo from '../assets/RBV.png';
...
function Education() {
  ...
  const educationData = [
    ...
    {
      institution: 'Rathnawali Balika Vidyalaya',
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(1200px 600px at 15% 20%,rgba(200, 165, 183, 0.71), transparent 60%), radial-gradient(900px 500px at 85% 80%,  rgba(159, 122, 120, 1), transparent 60%)',
        }}
      />
      ...
      <div className="relative z-10 container mx-auto px-6 max-w-6xl">
        <div className={`text-center mb-16 transition-all duration-600 ease-out ${
          ...
          <h2
            id="edu-title"
            className={`text-5xl sm:text-6xl font-extrabold tracking-tight bg-gradient-to-r from-pink-400 via-[#9A7E7D] to-red-400 bg-clip-text text-transparent pb-3 `}
          >
            Academic Journey
          </h2>
          <div
        ...
        <div className="relative max-w-4xl mx-auto">
          <div className="absolute left-1/2 transform -translate-x-1/2 w-1 bg-pink-700 h-full rounded-full hidden md:block"></div>
      ...
      <style>{`
        ...
        .edu-card-glow:before {
          ...
          inset: -1px;
          background:
            radial-gradient(800px 180px at var(--sx, 10%) -20%, rgba(248, 43, 145, 0.24), rgba(154, 126, 125, 1), transparent 35%),
            radial-gradient(520px 140px at var(--sx, 90%) 120%, rgba(131, 14, 10, 0.26), transparent 35%);
          opacity: var(--so, 0);
        ...
        .edu-card-glow:after {
          ...
          border-radius: 20px;
          background:
            radial-gradient(60% 60% at 50% 0%,rgba(199, 30, 24, 0.6), transparent 70%),
        ...
        .edu-card-glow:hover {
          ...
          box-shadow:
            ...
            0 12px 38px rgba(182, 10, 99, 0.48),
