...
import Chamathya from '../assets/Chamathya.jpg';
import myCv from '../assets/chamathyaCv.pdf';
...
function Profile() {
  ...
  useEffect(() => {
    ...
    const colorA = new THREE.Color('#C9B1BD');
    const colorB = new THREE.Color('#B49594');
  ...
  return (
    <section
      id="profile"
      className="relative min-h-screen flex items-center justify-center bg-[#441B2F] overflow-hidden py-20 px-4 sm:px-6"
      ref={containerRef}
    >
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(1200px 600px at 10% 10%,rgba(186, 128, 156, 1), transparent 60%), radial-gradient(1000px 500px at 90% 90%,  rgba(169, 106, 105, 1), transparent 60%)',
        }}
      />
      ...
      <div className="relative z-10 flex flex-col lg:flex-row items-center justify-center gap-12 lg:gap-16 max-w-7xl mx-auto" ref={contentRef}>
        ...
        <div className="text-center lg:text-left space-y-6 max-w-2xl">
          ...
          <motion.div
            className="h-1 w-24 bg-gradient-to-r from-[#B49594] to-[#CE7571] mx-auto lg:mx-0"
          ...
          >
            <span className="bg-gradient-to-r from-pink-400 via-[#9A7E7D] to-red-400 bg-clip-text text-transparent">
              {text}
            </span>
          ...
          >
            Full-stack Developer focused on crafting fast, reliable web apps.
          </motion.p>

          <motion.p
            className="text-base sm:text-lg text-gray-500 bold"
            initial={{ opacity: 0, y: 10 }}
            animate={isInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 10 }}
